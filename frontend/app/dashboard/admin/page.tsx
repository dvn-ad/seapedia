      ...
      <main className="flex-1 p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-850 dark:bg-zinc-900">
            <h3 className="text-lg font-bold mb-2">Voucher & Promo codes</h3>
            <p className="text-sm text-zinc-550 dark:text-zinc-400 mb-4">
              Configure marketplace discount campaigns.
            </p>
            <span className="text-xs text-zinc-450 block">Coupon editor will unlock in Level 6</span>
          </div>

          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-850 dark:bg-zinc-900">
            <h3 className="text-lg font-bold mb-2">System Metrics</h3>
            <p className="text-sm text-zinc-550 dark:text-zinc-400 mb-4">
              Tracks users, stores, products, orders, and logistics pipelines.
            </p>
            <span className="text-xs text-zinc-450 block">Analytics summaries will unlock in Level 6</span>
          </div>
        </div>
      </main>
    </div>
