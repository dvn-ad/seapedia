        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-850 dark:bg-zinc-900">
            ...
            <p className="text-sm text-zinc-550 dark:text-zinc-400 mb-4">
              There are no ready delivery jobs right now.
            </p>
            <span className="text-xs text-zinc-450 block">Job search and navigation maps will unlock in Level 5</span>
          </div>

          <div className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-850 dark:bg-zinc-900">
            <h3 className="text-lg font-bold mb-2">Earnings Summary</h3>
            <div className="text-3xl font-black text-indigo-600 dark:text-indigo-400 mb-4">
              Rp 0
            </div>
            <span className="text-xs text-zinc-450 block">Driver payroll logs will unlock in Level 5</span>
          </div>
        </div>
      </main>
    </div>
